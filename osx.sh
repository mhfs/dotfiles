...
sudo scutil --set ComputerName "mhfs-ofp"
sudo scutil --set HostName "mhfs-ofp"
sudo scutil --set LocalHostName "mhfs-ofp.local"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "mhfs-ofp"
...
# Enable Dashboard
defaults write com.apple.dashboard mcx-enabled -bool true
